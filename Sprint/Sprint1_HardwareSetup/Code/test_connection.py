    ...
    if hands:
        ...
        if len(hands) == 2:
            ...
            if f_count == h_count:
                ...
                if elapsed_time >= 1:
                    if f_count == 1:
                        cv2.putText(frame, 'Led 1 is on', (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 1, cv2.LINE_AA)
                    if f_count == 2:
                        cv2.putText(frame, 'Led 2 is on', (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 1, cv2.LINE_AA)
            ...
            if f_count == h_count:
                ...
                if elapsed_time >= 1:
                    if f_count == 0:
                        cv2.putText(frame, 'Leds are off', (200, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 1, cv2.LINE_AA)
                    if f_count == 5:
                        cv2.putText(frame, 'Leds are on', (200, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 1, cv2.LINE_AA)
                    cv2.putText(frame, f'Finger count: {f_count}', (20, 460), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1, cv2.LINE_AA)
                else:
                    cv2.putText(frame, f'Finger count: {h_count}', (20, 460), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1, cv2.LINE_AA)
            else:
