...
class HandDetector:
    ...
    """
    glasses: bool
    def __init__(self, staticMode=False, maxHands=2, modelComplexity=0,
                 detectionCon=0.5, minTrackCon=0.5,glasses=True):
    ...
    def is_back_faced(self,hand_landmarks,hand_type) -> bool: ...
    def findHands(self,img,draw=True,flipType=True) -> None: ...
    def fingersUp(self, myHand) -> list: ...
    ...
    def findHands(self, img, draw=True, flipType=True):
        ...
        if self.results.multi_hand_landmarks:
            for handType, handLms in zip(self.results.multi_handedness, self.results.multi_hand_landmarks):
                ...
                myHand["bbox"] = bbox
                myHand["center"] = (cx, cy)
                handsType.append(handType.classification[0].label)
                ...
                if self.glasses:
                    ...
                    # print((boxW+boxH)*2)
                    if self.fingersUp(myHand).count(1) == 0:
                        is_close = (boxW+boxH)*2 >= 400
                    else:
